...
def cluster_gen(n_clusters, pts_minmax=(100, 500), x_mult=(2, 7), y_mult=(2, 7), 
    ...
    :param x_mult: range of multiplier to modify size of cluster in x-direction
    :param y_mult: range of multiplier to modify size of cluster in y-direction
    ...
    :return: Tuple of 3 values, being the position (x, y) and labels
    """
